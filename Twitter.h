...
public:
  ...
  /*
  This will rt as well as unretweet the tweet based off of the tweet ID
  the difference is which api endpoint the twitter api is set to
  */
  bool post_rt();

  bool post_fav(String id);
...
private:
  ...
  //same as above but used for fav instead of post
  void compute_authorization_rt();
  void compute_authorization_fav(String id);
